...
The graph below is presented in my Shiny app, but the dodge histogram, [Distribution of Time Spent in Classes](classes_bar_graph.html), is reproduced at that link for ease of access.
...
I've also included the streamgraph here for an alternative visual [Evolution of Total Time Spent in Classes- Streamgraph](classes_streamgraph.html)
...
I have included the [Boxplot showing Distributions of Categories](boxplot.html) at that link. Similarly, I have shown the [Violin Plot showing Distributions of Categories](violin.html) at this link.
